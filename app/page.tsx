...
export default function Home() {
  ...
  useGSAP(() => {
    ...
    mm.add("(min-width: 769px)", () => {
      gsap.to(".line-track", { xPercent: -18, ease: "none", scrollTrigger: { trigger: ".lines", start: "top bottom", end: "bottom top", scrub: 1 } });
    });
    return () => mm.revert();
  }, { scope: root });
  ...
  return (
    <main ref={root} className="bg-[#f3f1ec] text-[#111820]">
      ...
      <section id="top" className="hero relative h-[100svh] min-h-[680px] overflow-hidden bg-black text-white">
        ...
        <div className="hero-title relative z-10 flex h-full flex-col justify-end px-6 pb-14 md:px-10 md:pb-20">
